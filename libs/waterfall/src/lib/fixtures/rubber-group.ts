...
export const actions: Action[] = [
  ...
  // TV FR
  action('income', { id: 'tv', amount: 10_000, from: 'fr_tv', to: 'fr_tv_com', territories: ['france'], medias: ['tv'] as any }),
  ...
  action('income', { id: 'collector', amount: 24_125, from: 'fr_collector', to: 'collector_rd', territories: ['france'], medias: ['dvd'] as any }),
  ...
  action('income', { id: 'vod', amount: 3_948, from: 'fr_vod', to: 'vod_rd', territories: ['france'], medias: ['vod'] as any }),
