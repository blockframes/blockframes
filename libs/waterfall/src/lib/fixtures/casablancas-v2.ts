    ...
    children: [
      {
        type: 'right', id: 'playtime_row_mg_fr_tv', orgId: 'playtime', percent: 0.15, pools: ['playtime_row_mg', 'amortization'], conditions: and([
          ...
          condition('terms', { type: 'territories', operator: 'in', list: ['fr'] as any }),
      ...
      },
      {
        type: 'right', id: 'playtime_row_mg_fr_svod', orgId: 'playtime', percent: 0.5, pools: ['playtime_row_mg', 'amortization'], conditions: and([
          condition('poolRevenu', { pool: 'playtime_row_mg', operator: '<', target: 50_000 }),
          condition('terms', { type: 'territories', operator: 'in', list: ['fr'] as any }),
          condition('terms', { type: 'medias', operator: 'in', list: ['svod'] as any }),
        ])
      },
      {
      ...
      },
      {
        type: 'right', id: 'playtime_row_mg_us', orgId: 'playtime', percent: 0.1, pools: ['playtime_row_mg', 'amortization'], conditions: and([
          condition('poolRevenu', { pool: 'playtime_row_mg', operator: '<', target: 50_000 }),
          condition('terms', { type: 'territories', operator: 'in', list: ['us', 'can'] as any }),
        ])
      },
      {
        type: 'right', id: 'playtime_row_mg_row', orgId: 'playtime', percent: 0.7, pools: ['playtime_row_mg', 'amortization'], conditions: and([
          condition('poolRevenu', { pool: 'playtime_row_mg', operator: '<', target: 50_000 }),
          condition('terms', { type: 'territories', operator: 'not-in', list: ['us', 'can', 'fr'] as any }),
        ])
      },
    ]
  }),
    ...
    children: [
      {
        type: 'right', id: 'soficinema_rnpp_fr_cine', orgId: 'soficinema', percent: 0.3, conditions: and([
          ...
          condition('terms', { type: 'territories', operator: 'in', list: ['fr'] as any }),
          condition('terms', { type: 'medias', operator: 'in', list: ['salles'] as any }),
        ])
      },
      {
        type: 'right', id: 'soficinema_rnpp_fr_video', orgId: 'soficinema', percent: 0.5, conditions: and([
          condition('orgRevenu', { orgId: 'soficinema', operator: '<', target: 115_000 }),
          condition('terms', { type: 'territories', operator: 'in', list: ['fr'] as any }),
          condition('terms', { type: 'medias', operator: 'in', list: ['dvd', 'vod', 'svod'] as any }),
        ])
      },
      {
...
const expensesAndIncomes: Action[] = [
  ...
  action('expense', { id:'expense_1', orgId: 'ufo', typeId: 'expense_fr', amount: 88_500, date: new Date('2016/03/09') }),
  ...
  action('income', { id: 'fr_dvd_1', contractId: 'ufo_fr', date: new Date('2016/03/09'), from: 'fr_dvd', to: 'ufo_fr_com_dvd', territories: ['fr'] as any, medias: ['dvd'] as any, amount: 0 }),
  // 09/03/16	fr_vod	fr_vod_1	fr_vod	0 €
  action('income', { id: 'fr_vod_1', contractId: 'ufo_fr', date: new Date('2016/03/09'), from: 'fr_vod', to: 'ufo_fr_com_vod', territories: ['fr'] as any, medias: ['vod'] as any, amount: 0 }),

  // --------- BLOCK 30/06/16 --------- 
  // 30/06/16	Playtime	10_828 €	expense_row	distrib
  action('expense', { id:'expense_2', orgId: 'playtime', typeId: 'expense_row', amount: 10_828, date: new Date('2016/06/30') }),
  // 30/06/16	Playtime	74 €	expense_row	cnc
  action('expense', { id:'expense_3', orgId: 'playtime', typeId: 'expense_row', amount: 74, date: new Date('2016/06/30') }),
  // 30/06/16	Playtime	10_200 €	expense_row	market
  action('expense', { id:'expense_3', orgId: 'playtime', typeId: 'expense_row', amount: 10_200, date: new Date('2016/06/30') }),

  // --------- BLOCK 31/12/16 --------- 
  // 31/12/16	Playtime	7 €	expense_row	cnc
  action('expense', { id:'expense_4', orgId: 'playtime', typeId: 'expense_row', amount: 7, date: new Date('2016/12/31') }),
  // 31/12/16	Playtime	17_821 €	expense_row	distrib
  action('expense', { id:'expense_5', orgId: 'playtime', typeId: 'expense_row', amount: 17_821, date: new Date('2016/12/31') }),
  ...
  action('expense', { id:'expense_6', orgId: 'playtime', typeId: 'expense_row', amount: 270, date: new Date('2017/02/28') }),
  // 28/02/17	Playtime	2_554 €	expense_row	distrib
  action('expense', { id:'expense_7', orgId: 'playtime', typeId: 'expense_row', amount: 2_554, date: new Date('2017/02/28') }),
  ...
  action('income', { id: 'netflix_row_1', contractId: 'netflix_row', date: new Date('2017/02/28'), from: 'row_svod', to: 'row_svod_com', territories: ['row'] as any, medias: ['svod'] as any, amount: 11_509 }),
  // 28/02/17	netflix_us	netflix_us_1	us_svod	11_509 €
  action('income', { id: 'netflix_us_1', contractId: 'netflix_us', date: new Date('2017/02/28'), from: 'us_svod', to: 'us_svod_com', territories: ['us', 'can'] as any, medias: ['svod'] as any, amount: 11_509 }),

  // --------- BLOCK 30/04/17 --------- 
  // 30/04/17	Playtime	-4_314 €	expense_row	distrib
  action('expense', { id:'expense_8', orgId: 'playtime', typeId: 'expense_row', amount: -4_703, date: new Date('2017/04/30') }),
  // 30/04/17	Playtime	6_065 €	expense_fr_tv	
  action('expense', { id:'expense_9', orgId: 'playtime', typeId: 'expense_fr_tv', amount: 6_065, date: new Date('2017/04/30') }),
  // 30/04/17	Playtime	7_500 €	expense_us	
  action('expense', { id:'expense_10', orgId: 'playtime', typeId: 'expense_us', amount: 7_500, date: new Date('2017/04/30') }),
  ...
  action('income', { id: 'netflix_us_2', contractId: 'netflix_us', date: new Date('2017/04/30'), from: 'us_svod', to: 'us_svod_com', territories: ['us', 'can'] as any, medias: ['svod'] as any, amount: 12_893 }),

  // --------- BLOCK 15/06/17 --------- 
  // 15/06/17	fr_cine	fr_cine_2	fr_cine	249 €
  action('income', { id: 'fr_cine_2', contractId: 'ufo_fr', date: new Date('2017/06/15'), from: 'fr_cine', to: 'ufo_fr_com_cine', territories: ['fr'] as any, medias: ['salle'] as any, amount: 249 }),
  // 15/06/17	fr_dvd	fr_dvd_2	fr_dvd	1_030 €
  action('income', { id: 'fr_dvd_2', contractId: 'ufo_fr', date: new Date('2017/06/15'), from: 'fr_dvd', to: 'ufo_fr_com_dvd', territories: ['fr'] as any, medias: ['dvd'] as any, amount: 1_030 }),
  // 15/06/17	fr_vod	fr_vod_2	fr_vod	3_117 €
  action('income', { id: 'fr_vod_2', contractId: 'ufo_fr', date: new Date('2017/06/15'), from: 'fr_vod', to: 'ufo_fr_com_vod', territories: ['fr'] as any, medias: ['vod'] as any, amount: 3_117 }),

  // --------- BLOCK 31/10/17 --------- 
  // 31/10/17	Playtime	404 €	expense_row	cnc
  action('expense', { id:'expense_11', orgId: 'playtime', typeId: 'expense_row', amount: 404, date: new Date('2017/10/31') }),
  // 31/10/17	Playtime	96 €	expense_row	distrib
  action('expense', { id:'expense_12', orgId: 'playtime', typeId: 'expense_row', amount: 96, date: new Date('2017/10/31') }),
  ...
  action('income', { id: 'netflix_us_3', contractId: 'netflix_us', date: new Date('2017/10/31'), from: 'us_svod', to: 'us_svod_com', territories: ['us', 'can'] as any, medias: ['svod'] as any, amount: 23_453 }),
  // 31/10/17	ocs_fr_tv	ocs_1	fr_tv	15_000 €
  action('income', { id: 'ocs_1', contractId: 'ocs_fr_tv', date: new Date('2017/10/31'), from: 'fr_tv', to: 'playtime_fr_com_tv', territories: ['fr'] as any, medias: ['tv'] as any, amount: 15_000 }),
  // 31/10/17	telepool_ger	telepool_1	row_all	50_000 €
  action('income', { id: 'telepool_1', contractId: 'telepool_ger', date: new Date('2017/10/31'), from: 'row_all', to: 'playtime_row_com_all', territories: ['row'] as any, medias: ['all'] as any, amount: 50_000 }),

  // --------- BLOCK 31/07/18 --------- 
  // 31/7/18	Playtime	257 €	expense_row	cnc
  action('expense', { id:'expense_12', orgId: 'playtime', typeId: 'expense_row', amount: 257, date: new Date('2018/07/31') }),
  // 31/7/18	Playtime	84 €	expense_row	distrib
  action('expense', { id:'expense_13', orgId: 'playtime', typeId: 'expense_row', amount: 84, date: new Date('2018/07/31') }),
  ...
  action('expense', { id:'expense_14', orgId: 'playtime', typeId: 'expense_row', amount: 88, date: new Date('2018/10/31') }),
  // 31/10/18	Playtime	28 €	expense_row	distrib
  action('expense', { id:'expense_15', orgId: 'playtime', typeId: 'expense_row', amount: 28, date: new Date('2018/10/31') }),
  ...
  action('income', { id: 'netflix_us_5', contractId: 'netflix_us', date: new Date('2018/10/31'), from: 'us_svod', to: 'us_svod_com', territories: ['us', 'can'] as any, medias: ['svod'] as any, amount: 11_777 }),

  // --------- BLOCK 28/02/19 --------- 
  // 28/02/19	Playtime	89 €	expense_row	cnc
  action('expense', { id:'expense_16', orgId: 'playtime', typeId: 'expense_row', amount: 89, date: new Date('2019/02/28') }),
  // 28/02/19	Playtime	28 €	expense_row	distrib
  action('expense', { id:'expense_17', orgId: 'playtime', typeId: 'expense_row', amount: 28, date: new Date('2019/02/28') }),
  ...
  action('income', { id: 'netflix_row_6', contractId: 'netflix_row', date: new Date('2019/02/28'), from: 'row_svod', to: 'row_svod_com', territories: ['row'] as any, medias: ['svod'] as any, amount: 9_661 }),
  // 28/02/19	netflix_us	netflix_us_6	us_svod	11_808 €
  action('income', { id: 'netflix_us_6', contractId: 'netflix_us', date: new Date('2019/02/28'), from: 'us_svod', to: 'us_svod_com', territories: ['us', 'can'] as any, medias: ['svod'] as any, amount: 11_808 }),

  // --------- BLOCK 31/05/19 --------- 
  // 31/05/19	Playtime	91 €	expense_row	cnc
  action('expense', { id:'expense_18', orgId: 'playtime', typeId: 'expense_row', amount: 91, date: new Date('2019/05/31') }),
  // 31/05/19	Playtime	140 €	expense_row	distrib
  action('expense', { id:'expense_19', orgId: 'playtime', typeId: 'expense_row', amount: 140, date: new Date('2019/05/31') }),
  ...
  action('income', { id: 'netflix_us_7', contractId: 'netflix_us', date: new Date('2019/05/31'), from: 'us_svod', to: 'us_svod_com', territories: ['us', 'can'] as any, medias: ['svod'] as any, amount: 12_131 }),

  // --------- BLOCK 31/10/19 ---------
  // 31/10/19	Playtime	183 €	expense_row	cnc
  action('expense', { id:'expense_20', orgId: 'playtime', typeId: 'expense_row', amount: 183, date: new Date('2019/10/31') }),
  // 31/10/19	Playtime	56 €	expense_row	distrib
  action('expense', { id:'expense_21', orgId: 'playtime', typeId: 'expense_row', amount: 56, date: new Date('2019/10/31') }),
  ...
  action('income', { id: 'netflix_us_8', contractId: 'netflix_us', date: new Date('2019/10/31'), from: 'us_svod', to: 'us_svod_com', territories: ['us', 'can'] as any, medias: ['svod'] as any, amount: 24_465 }),
];
