...
const incomes: Action[] = [
  ...
  action('income', { id: 'cine_theater', amount: 115_969, from: 'cine_theater', to: 'com_cine_commercial_ufo', territories: ['france'], medias: ['salle'] as any }),
  action('income', { id: 'fr_tv', amount: 10_000, from: 'fr_tv', to: 'ufo_com', territories: ['france'], medias: ['tv'] as any }),
  action('income', { id: 'extract_tv', amount: 250, from: 'extract_tv', to: 'rnpp', territories: ['france'], medias: ['tv'] as any }),
  action('income', { id: 'fr_rent', amount: 5_290, from: 'fr_rent', to: 'rent_rd', territories: ['france'], medias: ['dvd'] as any }),
  action('income', { id: 'fr_collector', amount: 24_125, from: 'fr_collector', to: 'collector_rd', territories: ['france'], medias: ['dvd'] as any }),
  action('income', { id: 'fr_sell_a', amount: 6_650, from: 'fr_sell', to: 'sell_rd', territories: ['france'], medias: ['dvd'] as any }),
  action('emitEvent', { eventId: 'fr_dvd_sold', value: 4_344 }),
  action('income', { id: 'fr_sell_b', amount: 22_433, from: 'fr_sell', to: 'sell_rd', territories: ['france'], medias: ['dvd'] as any }),
  action('income', { id: 'fr_vod', amount: 3_948, from: 'fr_vod', to: 'vod_rd', territories: ['france'], medias: ['vod'] as any }),
  action('income', { id: 'fr_svod', amount: 2_000, from: 'fr_svod', to: 'svod_rd', territories: ['france'], medias: ['svod'] as any }),
  action('income', { id: 'row_all', amount: 380_739, from: 'row_all', to: 'com_elledriver', territories: ['world'], medias: ['vod', 'tv', 'salle', 'svod', 'dvd'] as any }),
  action('income', { id: 'music', amount: 0, from: 'music', to: 'com_music', territories: ['world'], medias: ['cd'] as any }),
  ...
  action('income', { id: 'cine_theater_non_com', amount: 0, from: 'cine_theater_non_com', to: 'com_cine_non_commercial_ufo', territories: ['france'], medias: ['salle-non-com'] as any }),
];
