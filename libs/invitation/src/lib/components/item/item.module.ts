...
import { EventFromInvitationPipeModule } from '../../pipes/event-from-invitation.pipe';
import { MovieFromWaterfallInvitationPipeModule } from '../../pipes/waterfall-from-invitation.pipe';
