...
@Component({
  selector: 'event-container-video-saved',
  templateUrl: './container-video.component.html',
  styleUrls: ['./container-video.component.scss']
})
export class ContainerVideoComponentSaved implements OnInit, AfterViewInit, OnDestroy {
  ...
  ngAfterViewInit() {
    ...
    // const img = document.querySelector("#contener-event-meeting-saved");
