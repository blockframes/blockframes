...
import { MovieFormMediaImageComponent } from './media-image.component';
...
@NgModule({
  declarations: [MovieFormMediaImageComponent],
  imports: [
    CommonModule,
    ReactiveFormsModule,
    TunnelPageModule,
    ...
    MatDividerModule,
    // Route
    RouterModule.forChild([{ path: '', component: MovieFormMediaImageComponent }])
  ]
})
