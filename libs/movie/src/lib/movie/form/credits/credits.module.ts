...
import { MovieFormCreditsComponent } from './credits.component';
...
@NgModule({
    declarations: [MovieFormCreditsComponent],
    imports: [
      CommonModule,
      ReactiveFormsModule,
      TunnelPageModule,
      ...
      MatDividerModule,
      // Route
      RouterModule.forChild([{ path: '', component: MovieFormCreditsComponent }])
    ]
  })
