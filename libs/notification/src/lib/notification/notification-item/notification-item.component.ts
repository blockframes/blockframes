  ...
  public get message(): string {
    ...
    switch (this.notification.type) {
      case NotificationType.inviteOrganization:
        return `${this.notification.organization.denomination.full} has been invited to work on ${movieName}'s delivery.`;
      case NotificationType.removeOrganization:
        return `${this.notification.organization.denomination.full} has been removed from ${movieName}'s delivery.`;
      case NotificationType.newSignature:
        return `${this.notification.organization.denomination.full} has signed ${movieName}'s delivery.`;
