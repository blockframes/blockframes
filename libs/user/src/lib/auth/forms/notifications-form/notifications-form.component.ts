...
import { NotificationTypesBase, notificationTypesBase } from '@blockframes/shared/model';
...
const tables: { title: string; types: string[]; appAuthorized: App[] }[] = [
  ...
  },
  {
    ...
    types: ['movieAccepted', 'movieAskingPriceRequested', 'movieAskingPriceRequestSent'],
    appAuthorized: ['catalog', 'festival', 'financiers'],
  },
  {
