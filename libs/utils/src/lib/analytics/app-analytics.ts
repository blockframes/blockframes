...
import { EventName, AnalyticsUserProperties } from '@blockframes/shared/model';
...
export class FireAnalytics {
  constructor(public analytics: AngularFireAnalytics, private authService: AuthService) {}
