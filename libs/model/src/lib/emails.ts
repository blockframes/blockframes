...
import { ContractDocument, createMailContract } from "./contract";
import { MovieDocument } from "./movie";
import { OrganizationDocument, orgName } from "./organisation";
import { AccessibilityTypes, App, EventTypesValue } from "./static/types";
import { createMailTerm, MailTerm } from "./terms";
import { EventDocument, EventMeta, MeetingEventDocument, ScreeningEventDocument, SlateEventDocument } from "./event";
import { eventTypes, movieCurrenciesSymbols, staticModel } from "./static/static-model";
import { toLabel } from "./utils";
import { User } from "./user";
import { Offer } from "./offer";
import { NegotiationDocument } from "./negociation";
import { Timestamp } from "./timestamp";
import { getKeyIfExists } from "@blockframes/utils/helpers";
import { toIcsFile } from '@blockframes/utils/agenda/utils';
import { IcsEvent } from '@blockframes/utils/agenda/agenda.interfaces';
...
function getEventEmailAttachment(event: EventDocument<EventMeta>, orgName: string): AttachmentData {
  ...
  return {
    ...
    // @ts-ignore
    content: Buffer.from(toIcsFile([icsEvent])).toString('base64'), // TODO: #8621 - replace Buffer
