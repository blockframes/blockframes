...
export const languages = {
 ...
 'assyrian-neo-aramaic': 'Assyrian Neo Aramaic',
  ...
  balochi: 'Balochi',
  bambara: 'Bambara',
  'bandjabi-gambia': 'Bandjabi Gambia',
  bangla: 'Bangla',
  bantu: 'Bantu',
  ...
  catalan: 'Catalan',
  cebuano: 'Cebuano',
  'central-tibetan': 'Central Tibetan',
  chichewa: 'Chichewa',
  chin: 'Chin',
  chinese: 'Chinese',
  chukese: 'Chukese',
  ...
  myanmar: 'Myanmar (formerly Burmese)',
  myene: 'Myene',
  nahua: 'Nahua',
  nauruan: 'Nauruan',
  ndebele: 'Ndebele',
  nepalese: 'Nepalese dialect',
  nepali: 'Nepali',
  newar: 'Newar',
  ...
  provençal: 'Provençal (French regional dialects)',
  pulaar: 'Pulaar',
  punjabi: 'Punjabi',
  quechua: 'Quechua',
  quéchua: 'Quéchua',
