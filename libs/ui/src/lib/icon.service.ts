...
export const icons = [
  ...
  { name: 'excel_export', url: 'assets/icons/excel_export.svg' },
  ...
  { name: 'mini_logo_catalog', url: 'assets/icons/mini_logo_catalog.svg' },
  { name: 'mini_logo_festival', url: 'assets/icons/mini_logo_festival.svg' },
  ...
  { name: 'plus_circle', url: 'assets/icons/plus_circle.svg' },
  ...
  { name: 'video_recorder', url: 'assets/icons/video_recorder.svg' },
