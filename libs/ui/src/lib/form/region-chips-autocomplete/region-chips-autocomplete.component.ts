...
@Component({
  ...
  templateUrl: './region-chips-autocomplete.component.html',
  styleUrls: ['./region-chips-autocomplete.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class RegionChipsAutocompleteComponent implements OnInit, OnDestroy {
