...
import { Duration, Term, TermBase } from "../term/+state/term.model";
...
function collidingHoldback(holdback: Holdback, term: TermBase) {
...
export function getCollidingHoldbacks(holdbacks: Holdback[], terms: TermBase[]) {
