...
import { availableTerritories, getMandateTerms, termsOverlap, toTerritoryMarker } from "./../avails";
...
describe('Test availableTerritories pure function', () => {
  ...
  it('Return sold terms according to availsForm values', () => {
    ...
    const soldTerms = termsOverlap(availDetailsExclusive, [termA, termB, termC, termD]);
  ...
  it('When getting sold terms, should return none if not exclusive', () => {
    ...
    const soldTerms = termsOverlap(availDetailsNonExclusive, [termA, termB, termC, termD]);
