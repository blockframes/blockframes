 ...
 * and introduce separation of concern between the client code (create contract, generate notification, etc)
 * and the storage layer (firestore, retrieve document, access path `/contract/${contractId}/x/y`
 *
 ...
 *   and our business code (Distribution rights, Contract, etc),
