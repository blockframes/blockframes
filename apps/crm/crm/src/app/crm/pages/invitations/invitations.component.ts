...
import { Movie, Organization, orgName, Event, isScreening, InvitationDetailed } from '@blockframes/shared/model';
...
export class InvitationsComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    const [orgs, movies] = await Promise.all([this.orgService.getValue(orgIds), this.movieService.getValue(movieIds)]);
