...
export const panelRoutes: Routes = [
  ...
  { path: 'external-sales', loadChildren:() => import('./pages/external-sales/list/list.module').then(s => s.CrmContractsListModule) },
  { path: 'external-sales/:saleId', loadChildren:() => import('./pages/external-sales/view/view.module').then(s => s.ContractViewModule) },
